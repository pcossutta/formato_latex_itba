...
\newcommand*{\engsubtitle}[1]{\gdef\@engsubtitle{#1}}
\newcommand*{\engdate}[1]{\gdef\@engdate{#1}}
...
\input{preamble/EnglishCover.tex} %% ELIMINAR SI LA TESIS ESTA ESCRITA EN CASTELLANO
